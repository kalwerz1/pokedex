...
$databaseConnection = mysqli_connect(
  ...
  printf ("ID: %s <br>Nom: %s<br>URL: %s<br>PV: %s<br>PtsAttaque: %s<br>PtsDefense: %s<br>PtsSpecial: %s<br>PtsVitesse: %s<br>DateAjout: %s<br>idType2: %s<br>idType1: %s", $row[0], $row[1], $row[2], $row[3], $row[4], $row[5], $row[6], $row[7], $row[8], $row[9],$row[10]);
